...
implements ICFBamJavaFXDbKeyHash512ColPaneList
{
	...
	protected TableColumn<ICFBamDbKeyHash512ColObj, ICFLibKeyHash256> tableColumnId = null;
		...
		ICFBamJavaFXDbKeyHash512ColChosen whenChosen )
	{
		...
		tableColumnId = new TableColumn<ICFBamDbKeyHash512ColObj,ICFLibKeyHash256>( "Id" );
		tableColumnId.setCellValueFactory( new Callback<CellDataFeatures<ICFBamDbKeyHash512ColObj,ICFLibKeyHash256>,ObservableValue<ICFLibKeyHash256> >() {
			public ObservableValue<ICFLibKeyHash256> call( CellDataFeatures<ICFBamDbKeyHash512ColObj, ICFLibKeyHash256> p ) {
		...
		tableColumnId.setCellFactory( new Callback<TableColumn<ICFBamDbKeyHash512ColObj,ICFLibKeyHash256>,TableCell<ICFBamDbKeyHash512ColObj,ICFLibKeyHash256>>() {
			@Override public TableCell<ICFBamDbKeyHash512ColObj,ICFLibKeyHash256> call(
				TableColumn<ICFBamDbKeyHash512ColObj,ICFLibKeyHash256> arg)
			{
