...
implements ICFBamJavaFXInt16TypePaneList
{
	...
	protected TableColumn<ICFBamInt16TypeObj, ICFLibKeyHash256> tableColumnId = null;
		...
		boolean sortByChain )
	{
		...
		tableColumnId = new TableColumn<ICFBamInt16TypeObj,ICFLibKeyHash256>( "Id" );
		tableColumnId.setCellValueFactory( new Callback<CellDataFeatures<ICFBamInt16TypeObj,ICFLibKeyHash256>,ObservableValue<ICFLibKeyHash256> >() {
			public ObservableValue<ICFLibKeyHash256> call( CellDataFeatures<ICFBamInt16TypeObj, ICFLibKeyHash256> p ) {
		...
		tableColumnId.setCellFactory( new Callback<TableColumn<ICFBamInt16TypeObj,ICFLibKeyHash256>,TableCell<ICFBamInt16TypeObj,ICFLibKeyHash256>>() {
			@Override public TableCell<ICFBamInt16TypeObj,ICFLibKeyHash256> call(
				TableColumn<ICFBamInt16TypeObj,ICFLibKeyHash256> arg)
			{
