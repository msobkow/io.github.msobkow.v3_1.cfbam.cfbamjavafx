...
implements ICFBamJavaFXClearSubDep1PaneList
{
	...
	protected TableColumn<ICFBamClearSubDep1Obj, $implJavaOptAtomType$> tableColumnId = null;
	protected TableColumn<ICFBamClearSubDep1Obj, $implJavaOptAtomType$> tableColumnName = null;
		...
		ICFBamJavaFXClearSubDep1Chosen whenChosen )
	{
		...
		tableColumnId = new TableColumn<ICFBamClearSubDep1Obj,$implJavaOptAtomType$>( "Id" );
		tableColumnId.setCellValueFactory( new Callback<CellDataFeatures<ICFBamClearSubDep1Obj,$implJavaOptAtomType$>,ObservableValue<$implJavaOptAtomType$> >() {
			public ObservableValue<$implJavaOptAtomType$> call( CellDataFeatures<ICFBamClearSubDep1Obj, $implJavaOptAtomType$> p ) {
		...
		tableColumnId.setCellFactory( new Callback<TableColumn<ICFBamClearSubDep1Obj,$implJavaOptAtomType$>,TableCell<ICFBamClearSubDep1Obj,$implJavaOptAtomType$>>() {
			@Override public TableCell<ICFBamClearSubDep1Obj,$implJavaOptAtomType$> call(
				TableColumn<ICFBamClearSubDep1Obj,$implJavaOptAtomType$> arg)
			{
				return new CFDbKeyHash256TableCell<ICFBamClearSubDep1Obj>();
			}
		});
		dataTable.getColumns().add( tableColumnId );
		tableColumnName = new TableColumn<ICFBamClearSubDep1Obj,$implJavaOptAtomType$>( "Name" );
		tableColumnName.setCellValueFactory( new Callback<CellDataFeatures<ICFBamClearSubDep1Obj,$implJavaOptAtomType$>,ObservableValue<$implJavaOptAtomType$> >() {
			public ObservableValue<$implJavaOptAtomType$> call( CellDataFeatures<ICFBamClearSubDep1Obj, $implJavaOptAtomType$> p ) {
		...
		tableColumnName.setCellFactory( new Callback<TableColumn<ICFBamClearSubDep1Obj,$implJavaOptAtomType$>,TableCell<ICFBamClearSubDep1Obj,$implJavaOptAtomType$>>() {
			@Override public TableCell<ICFBamClearSubDep1Obj,$implJavaOptAtomType$> call(
				TableColumn<ICFBamClearSubDep1Obj,$implJavaOptAtomType$> arg)
			{
