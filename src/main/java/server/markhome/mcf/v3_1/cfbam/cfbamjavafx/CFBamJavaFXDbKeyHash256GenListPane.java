...
implements ICFBamJavaFXDbKeyHash256GenPaneList
{
	...
	protected TableColumn<ICFBamDbKeyHash256GenObj, ICFLibKeyHash256> tableColumnId = null;
		...
		boolean sortByChain )
	{
		...
		tableColumnId = new TableColumn<ICFBamDbKeyHash256GenObj,ICFLibKeyHash256>( "Id" );
		tableColumnId.setCellValueFactory( new Callback<CellDataFeatures<ICFBamDbKeyHash256GenObj,ICFLibKeyHash256>,ObservableValue<ICFLibKeyHash256> >() {
			public ObservableValue<ICFLibKeyHash256> call( CellDataFeatures<ICFBamDbKeyHash256GenObj, ICFLibKeyHash256> p ) {
		...
		tableColumnId.setCellFactory( new Callback<TableColumn<ICFBamDbKeyHash256GenObj,ICFLibKeyHash256>,TableCell<ICFBamDbKeyHash256GenObj,ICFLibKeyHash256>>() {
			@Override public TableCell<ICFBamDbKeyHash256GenObj,ICFLibKeyHash256> call(
				TableColumn<ICFBamDbKeyHash256GenObj,ICFLibKeyHash256> arg)
			{
