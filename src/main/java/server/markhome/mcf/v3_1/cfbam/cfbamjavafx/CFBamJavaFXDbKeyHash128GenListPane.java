...
implements ICFBamJavaFXDbKeyHash128GenPaneList
{
	...
	protected TableColumn<ICFBamDbKeyHash128GenObj, ICFLibKeyHash256> tableColumnId = null;
		...
		boolean sortByChain )
	{
		...
		tableColumnId = new TableColumn<ICFBamDbKeyHash128GenObj,ICFLibKeyHash256>( "Id" );
		tableColumnId.setCellValueFactory( new Callback<CellDataFeatures<ICFBamDbKeyHash128GenObj,ICFLibKeyHash256>,ObservableValue<ICFLibKeyHash256> >() {
			public ObservableValue<ICFLibKeyHash256> call( CellDataFeatures<ICFBamDbKeyHash128GenObj, ICFLibKeyHash256> p ) {
		...
		tableColumnId.setCellFactory( new Callback<TableColumn<ICFBamDbKeyHash128GenObj,ICFLibKeyHash256>,TableCell<ICFBamDbKeyHash128GenObj,ICFLibKeyHash256>>() {
			@Override public TableCell<ICFBamDbKeyHash128GenObj,ICFLibKeyHash256> call(
				TableColumn<ICFBamDbKeyHash128GenObj,ICFLibKeyHash256> arg)
			{
