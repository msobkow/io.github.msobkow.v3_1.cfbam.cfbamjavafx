...
implements ICFBamJavaFXTimestampColPaneList
{
	...
	protected TableColumn<ICFBamTimestampColObj, ICFLibKeyHash256> tableColumnId = null;
		...
		ICFBamJavaFXTimestampColChosen whenChosen )
	{
		...
		tableColumnId = new TableColumn<ICFBamTimestampColObj,ICFLibKeyHash256>( "Id" );
		tableColumnId.setCellValueFactory( new Callback<CellDataFeatures<ICFBamTimestampColObj,ICFLibKeyHash256>,ObservableValue<ICFLibKeyHash256> >() {
			public ObservableValue<ICFLibKeyHash256> call( CellDataFeatures<ICFBamTimestampColObj, ICFLibKeyHash256> p ) {
		...
		tableColumnId.setCellFactory( new Callback<TableColumn<ICFBamTimestampColObj,ICFLibKeyHash256>,TableCell<ICFBamTimestampColObj,ICFLibKeyHash256>>() {
			@Override public TableCell<ICFBamTimestampColObj,ICFLibKeyHash256> call(
				TableColumn<ICFBamTimestampColObj,ICFLibKeyHash256> arg)
			{
