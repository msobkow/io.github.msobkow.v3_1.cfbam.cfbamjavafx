...
implements ICFBamJavaFXUInt32DefPaneList
{
	...
	protected TableColumn<ICFBamUInt32DefObj, ICFLibKeyHash256> tableColumnId = null;
		...
		ICFBamJavaFXUInt32DefChosen whenChosen )
	{
		...
		tableColumnId = new TableColumn<ICFBamUInt32DefObj,ICFLibKeyHash256>( "Id" );
		tableColumnId.setCellValueFactory( new Callback<CellDataFeatures<ICFBamUInt32DefObj,ICFLibKeyHash256>,ObservableValue<ICFLibKeyHash256> >() {
			public ObservableValue<ICFLibKeyHash256> call( CellDataFeatures<ICFBamUInt32DefObj, ICFLibKeyHash256> p ) {
		...
		tableColumnId.setCellFactory( new Callback<TableColumn<ICFBamUInt32DefObj,ICFLibKeyHash256>,TableCell<ICFBamUInt32DefObj,ICFLibKeyHash256>>() {
			@Override public TableCell<ICFBamUInt32DefObj,ICFLibKeyHash256> call(
				TableColumn<ICFBamUInt32DefObj,ICFLibKeyHash256> arg)
			{
