...
implements ICFBamJavaFXUInt32ColPaneList
{
	...
	protected TableColumn<ICFBamUInt32ColObj, ICFLibKeyHash256> tableColumnId = null;
		...
		boolean sortByChain )
	{
		...
		tableColumnId = new TableColumn<ICFBamUInt32ColObj,ICFLibKeyHash256>( "Id" );
		tableColumnId.setCellValueFactory( new Callback<CellDataFeatures<ICFBamUInt32ColObj,ICFLibKeyHash256>,ObservableValue<ICFLibKeyHash256> >() {
			public ObservableValue<ICFLibKeyHash256> call( CellDataFeatures<ICFBamUInt32ColObj, ICFLibKeyHash256> p ) {
		...
		tableColumnId.setCellFactory( new Callback<TableColumn<ICFBamUInt32ColObj,ICFLibKeyHash256>,TableCell<ICFBamUInt32ColObj,ICFLibKeyHash256>>() {
			@Override public TableCell<ICFBamUInt32ColObj,ICFLibKeyHash256> call(
				TableColumn<ICFBamUInt32ColObj,ICFLibKeyHash256> arg)
			{
