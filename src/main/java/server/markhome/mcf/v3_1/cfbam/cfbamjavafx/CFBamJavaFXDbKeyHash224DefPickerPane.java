...
implements ICFBamJavaFXDbKeyHash224DefPaneList
{
	...
	protected TableColumn<ICFBamDbKeyHash224DefObj, ICFLibKeyHash256> tableColumnId = null;
		...
		ICFBamJavaFXDbKeyHash224DefChosen whenChosen )
	{
		...
		tableColumnId = new TableColumn<ICFBamDbKeyHash224DefObj,ICFLibKeyHash256>( "Id" );
		tableColumnId.setCellValueFactory( new Callback<CellDataFeatures<ICFBamDbKeyHash224DefObj,ICFLibKeyHash256>,ObservableValue<ICFLibKeyHash256> >() {
			public ObservableValue<ICFLibKeyHash256> call( CellDataFeatures<ICFBamDbKeyHash224DefObj, ICFLibKeyHash256> p ) {
		...
		tableColumnId.setCellFactory( new Callback<TableColumn<ICFBamDbKeyHash224DefObj,ICFLibKeyHash256>,TableCell<ICFBamDbKeyHash224DefObj,ICFLibKeyHash256>>() {
			@Override public TableCell<ICFBamDbKeyHash224DefObj,ICFLibKeyHash256> call(
				TableColumn<ICFBamDbKeyHash224DefObj,ICFLibKeyHash256> arg)
			{
