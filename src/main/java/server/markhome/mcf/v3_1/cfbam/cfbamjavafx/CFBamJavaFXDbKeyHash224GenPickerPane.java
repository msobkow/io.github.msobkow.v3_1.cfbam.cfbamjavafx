...
implements ICFBamJavaFXDbKeyHash224GenPaneList
{
	...
	protected TableColumn<ICFBamDbKeyHash224GenObj, ICFLibKeyHash256> tableColumnId = null;
		...
		ICFBamJavaFXDbKeyHash224GenChosen whenChosen )
	{
		...
		tableColumnId = new TableColumn<ICFBamDbKeyHash224GenObj,ICFLibKeyHash256>( "Id" );
		tableColumnId.setCellValueFactory( new Callback<CellDataFeatures<ICFBamDbKeyHash224GenObj,ICFLibKeyHash256>,ObservableValue<ICFLibKeyHash256> >() {
			public ObservableValue<ICFLibKeyHash256> call( CellDataFeatures<ICFBamDbKeyHash224GenObj, ICFLibKeyHash256> p ) {
		...
		tableColumnId.setCellFactory( new Callback<TableColumn<ICFBamDbKeyHash224GenObj,ICFLibKeyHash256>,TableCell<ICFBamDbKeyHash224GenObj,ICFLibKeyHash256>>() {
			@Override public TableCell<ICFBamDbKeyHash224GenObj,ICFLibKeyHash256> call(
				TableColumn<ICFBamDbKeyHash224GenObj,ICFLibKeyHash256> arg)
			{
