...
implements ICFBamJavaFXInt32TypePaneList
{
	...
	protected TableColumn<ICFBamInt32TypeObj, ICFLibKeyHash256> tableColumnId = null;
		...
		ICFBamJavaFXInt32TypeChosen whenChosen )
	{
		...
		tableColumnId = new TableColumn<ICFBamInt32TypeObj,ICFLibKeyHash256>( "Id" );
		tableColumnId.setCellValueFactory( new Callback<CellDataFeatures<ICFBamInt32TypeObj,ICFLibKeyHash256>,ObservableValue<ICFLibKeyHash256> >() {
			public ObservableValue<ICFLibKeyHash256> call( CellDataFeatures<ICFBamInt32TypeObj, ICFLibKeyHash256> p ) {
		...
		tableColumnId.setCellFactory( new Callback<TableColumn<ICFBamInt32TypeObj,ICFLibKeyHash256>,TableCell<ICFBamInt32TypeObj,ICFLibKeyHash256>>() {
			@Override public TableCell<ICFBamInt32TypeObj,ICFLibKeyHash256> call(
				TableColumn<ICFBamInt32TypeObj,ICFLibKeyHash256> arg)
			{
