...
implements ICFBamJavaFXUuid6DefPaneList
{
	...
	protected TableColumn<ICFBamUuid6DefObj, ICFLibKeyHash256> tableColumnId = null;
		...
		boolean sortByChain )
	{
		...
		tableColumnId = new TableColumn<ICFBamUuid6DefObj,ICFLibKeyHash256>( "Id" );
		tableColumnId.setCellValueFactory( new Callback<CellDataFeatures<ICFBamUuid6DefObj,ICFLibKeyHash256>,ObservableValue<ICFLibKeyHash256> >() {
			public ObservableValue<ICFLibKeyHash256> call( CellDataFeatures<ICFBamUuid6DefObj, ICFLibKeyHash256> p ) {
		...
		tableColumnId.setCellFactory( new Callback<TableColumn<ICFBamUuid6DefObj,ICFLibKeyHash256>,TableCell<ICFBamUuid6DefObj,ICFLibKeyHash256>>() {
			@Override public TableCell<ICFBamUuid6DefObj,ICFLibKeyHash256> call(
				TableColumn<ICFBamUuid6DefObj,ICFLibKeyHash256> arg)
			{
