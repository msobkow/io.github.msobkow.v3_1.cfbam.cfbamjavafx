...
implements ICFBamJavaFXInt16DefPaneList
{
	...
	protected TableColumn<ICFBamInt16DefObj, ICFLibKeyHash256> tableColumnId = null;
		...
		ICFBamJavaFXInt16DefChosen whenChosen )
	{
		...
		tableColumnId = new TableColumn<ICFBamInt16DefObj,ICFLibKeyHash256>( "Id" );
		tableColumnId.setCellValueFactory( new Callback<CellDataFeatures<ICFBamInt16DefObj,ICFLibKeyHash256>,ObservableValue<ICFLibKeyHash256> >() {
			public ObservableValue<ICFLibKeyHash256> call( CellDataFeatures<ICFBamInt16DefObj, ICFLibKeyHash256> p ) {
		...
		tableColumnId.setCellFactory( new Callback<TableColumn<ICFBamInt16DefObj,ICFLibKeyHash256>,TableCell<ICFBamInt16DefObj,ICFLibKeyHash256>>() {
			@Override public TableCell<ICFBamInt16DefObj,ICFLibKeyHash256> call(
				TableColumn<ICFBamInt16DefObj,ICFLibKeyHash256> arg)
			{
