...
implements ICFBamJavaFXDbKeyHash512TypePaneList
{
	...
	protected TableColumn<ICFBamDbKeyHash512TypeObj, ICFLibKeyHash256> tableColumnId = null;
		...
		ICFBamJavaFXDbKeyHash512TypeChosen whenChosen )
	{
		...
		tableColumnId = new TableColumn<ICFBamDbKeyHash512TypeObj,ICFLibKeyHash256>( "Id" );
		tableColumnId.setCellValueFactory( new Callback<CellDataFeatures<ICFBamDbKeyHash512TypeObj,ICFLibKeyHash256>,ObservableValue<ICFLibKeyHash256> >() {
			public ObservableValue<ICFLibKeyHash256> call( CellDataFeatures<ICFBamDbKeyHash512TypeObj, ICFLibKeyHash256> p ) {
		...
		tableColumnId.setCellFactory( new Callback<TableColumn<ICFBamDbKeyHash512TypeObj,ICFLibKeyHash256>,TableCell<ICFBamDbKeyHash512TypeObj,ICFLibKeyHash256>>() {
			@Override public TableCell<ICFBamDbKeyHash512TypeObj,ICFLibKeyHash256> call(
				TableColumn<ICFBamDbKeyHash512TypeObj,ICFLibKeyHash256> arg)
			{
