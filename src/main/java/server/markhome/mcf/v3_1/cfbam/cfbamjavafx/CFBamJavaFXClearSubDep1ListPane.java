...
implements ICFBamJavaFXClearSubDep1PaneList
{
	...
	protected TableColumn<ICFBamClearSubDep1Obj, ICFLibKeyHash256> tableColumnId = null;
		...
		boolean sortByChain )
	{
		...
		tableColumnId = new TableColumn<ICFBamClearSubDep1Obj,ICFLibKeyHash256>( "Id" );
		tableColumnId.setCellValueFactory( new Callback<CellDataFeatures<ICFBamClearSubDep1Obj,ICFLibKeyHash256>,ObservableValue<ICFLibKeyHash256> >() {
			public ObservableValue<ICFLibKeyHash256> call( CellDataFeatures<ICFBamClearSubDep1Obj, ICFLibKeyHash256> p ) {
		...
		tableColumnId.setCellFactory( new Callback<TableColumn<ICFBamClearSubDep1Obj,ICFLibKeyHash256>,TableCell<ICFBamClearSubDep1Obj,ICFLibKeyHash256>>() {
			@Override public TableCell<ICFBamClearSubDep1Obj,ICFLibKeyHash256> call(
				TableColumn<ICFBamClearSubDep1Obj,ICFLibKeyHash256> arg)
			{
